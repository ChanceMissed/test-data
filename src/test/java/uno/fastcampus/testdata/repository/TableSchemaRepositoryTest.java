...
class TableSchemaRepositoryTest {
    ...
    @DisplayName("사용자별 테이블 스키마를 조회하면, 테이블 스키마를 반환한다.")
    @Test
    void givenUserId_whenSelectingTableSchemas_thenReturnsTableSchema(){
        // Given
        var userId = "djkeh";
    ...
    @Test
    void givenUserId_whenDeletingTableSchemas_thenDeletes(){
        // Given
        var userId = "djkeh";
        var schemaName = "test_schema1";
